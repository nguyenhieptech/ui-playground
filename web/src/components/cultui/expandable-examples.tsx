            ...
            <ExpandableCardContent>
              ...
              <ExpandableContent preset="blur-md" stagger staggerChildren={0.2}>
                <p className="mb-4 text-sm text-gray-700 dark:text-gray-200">
                  Weekly design sync to discuss ongoing projects, share updates, and
                  address any design-related challenges.
                </p>
                <div className="mb-4">
            ...
            <ExpandableCardContent>
              ...
              >
                <p className="mb-4 max-w-xs text-sm text-gray-600 dark:text-gray-400">
                  ...
                  technology. Perfect for work, travel, or relaxation.
                </p>
...
function ExpandableCardExamples() {
  return (
